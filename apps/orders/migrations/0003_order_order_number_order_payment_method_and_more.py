# Generated by Django 6.0.4 on 2026-06-07 18:23
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('orders', '0002_order_cancellation_reason_order_completed_at_and_more'),
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='order',
            name='status',
            field=models.CharField(choices=[('pending', 'Pending'), ('processing', 'Processing'), ('paid', 'Paid'), ('shipped', 'Shipped'), ('completed', 'Completed'), ('cancelled', 'Cancelled')], default='pending', max_length=20),
        ),
        migrations.AlterField(
            model_name='orderitem',
            name='price',
            field=djmoney.models.fields.MoneyField(decimal_places=2, default_currency='USD', max_digits=10, validators=[django.core.validators.MinValueValidator(Decimal('0.00'))]),
        ),
        migrations.AlterField(
            model_name='orderitem',
            name='quantity',
        ...
        migrations.AddIndex(
            model_name='orderitem',
            index=models.Index(fields=['shop_product'], name='orders_orde_shop_pr_1327a1_idx'),
        ),
        migrations.AddConstraint(
            model_name='order',
            constraint=models.CheckConstraint(condition=models.Q(('total_price__gte', 0)), name='order_total_price_gte_zero'),
        ),
        migrations.AddConstraint(
            model_name='order',
            constraint=models.CheckConstraint(condition=models.Q(('total_items__gte', 0)), name='order_total_items_gte_zero'),
        ),
        migrations.AddConstraint(
            model_name='orderitem',
            constraint=models.UniqueConstraint(fields=('order', 'shop_product'), name='unique_product_per_order'),
        ),
        migrations.AddConstraint(
            model_name='orderitem',
            constraint=models.CheckConstraint(condition=models.Q(('quantity__gte', 0)), name='orderitem_quantity_gt_zero'),
        ),
        migrations.AddConstraint(
            model_name='orderitem',
